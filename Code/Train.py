...
def TrainOperation(ImgPH, LabelPH, DirNamesTrain, TrainLabels, NumTrainSamples, ImageSize,
    ...
    prLogits, prSoftMax = CIFAR10Model(ImgPH, ImageSize, MiniBatchSize*3)
    #prLogits, prSoftMax = ResNetModel(ImgPH, ImageSize, MiniBatchSize*3)
    #prLogits, prSoftMax = ResNext(ImgPH, ImageSize, MiniBatchSize*3)
    #prLogits, prSoftMax = DenseNet(ImgPH, ImageSize, MiniBatchSize*3)
...
def main():
    ...
    Parser.add_argument('--BasePath', default='/home/raghav/Desktop/Phase2/CIFAR10', help='Base path of images, Default:/media/nitin/Research/Homing/SpectralCompression/CIFAR10')
