...
def main():
    ...
    Parser.add_argument('--ModelPath', dest='ModelPath', default='/home/raghav/Desktop/Temp/Phase2/sssss/densenet/24model.ckpt', help='Path to load latest model from, Default:ModelPath')
    Parser.add_argument('--BasePath', dest='BasePath', default='/home/raghav/Desktop/Temp/Phase2/CIFAR10/Test/', help='Path to load images from, Default:BasePath')
    Parser.add_argument('--LabelsPath', dest='LabelsPath', default='/home/raghav/Desktop/Temp/Phase2/Code/TxtFiles/LabelsTest.txt', help='Path of labels file, Default:./TxtFiles/LabelsTest.txt')
